...
def test_code():
    @pytest.mark.mpl_image_compare(tolerance=0.03, remove_text=False, style="default")
    def test_plot(
        methodToRun,
        proj,
        use_ax,
    ...
    # Gridded stats
    test_plot(
        hurdat_atl.gridded_stats, proj, True, ["maximum wind"], {}, use_figsize=(14, 9)
    )
